...
# In this section, I learned that accessing a list or a tuple can be done from behind
...
# In this section, I learned that we can be slicing through the list or the tuple to take multiple variable
...
# In this section, I learned that we can combine two or more lists or tuples
...
# In this section, I learned about various list manipulation
...
# In this section, I learned about various tuple manipulation
...
# In this section, I learned about various set manipulation
...
# In this section, I learned about various dictionary manipulation
...
# In this section, I learned that we can counting variables at the tuple and list. Also we can convert the type of data
...
# In this section, I implemented the knowledge I had previously achieved. It's about calculating average income and average expenditure
...
for judul in judul_artikel: 
    for kata in kata_positif:
        if judul.count("Jeruk") > 0 and judul.count(kata) > 0: # loop yang kedua dikasih catatan nanti
...
print(all_lines)
# Membaca file hello.txt dengan fungsi readline()
print(">>> Membaca file hello.txt dengan menerapkan for looping")
file = open("hello.txt", "r")
for line in file:
    print(line)
file.close
